...
router.get("/", async function (req, res, next) {
  try {
    ...
    const companies = await Company.filter(query);
...
router.patch("/:handle", ensureLoggedIn, ensureAdminThere, async function (req, res, next) {
  try {
...
router.delete("/:handle", ensureLoggedIn, ensureAdminThere, async function (req, res, next) {
  try {
